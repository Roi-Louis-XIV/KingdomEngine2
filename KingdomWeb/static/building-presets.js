...
window.KingdomBuildingPresets = [
  {
    ...
    name: "Récolte",
    description:
      "Les joueurs dépensent de l’énergie pour obtenir des ressources.",
    example: "Mine, forêt, ferme, carrière",
    payload: {
      building_kind: "harvest",
      emoji: "🌲",
      color: "22c55e",
      description:
        "Un lieu où les aventuriers récoltent les ressources du Royaume.",
      actions: [
        {
          key: "gather_resources",
          name: "Récolter",
          emoji: "🧺",
          enabled: true,
          effects: [
  ...
  },
  {
    ...
    payload: {
      building_kind: "commerce",
      emoji: "🛒",
      color: "8b5cf6",
      description:
        "Un commerce où dépenser ses pièces et découvrir de nouveaux objets.",
      actions: [
        {
          key: "buy_item",
          name: "Acheter",
          ...
          effects: [
            ...
            {
              type: "message",
              text: "Votre achat a bien été ajouté à l’inventaire.",
            },
          ],
        },
      ],
      ...
      actions: [
        {
          ...
          effects: [
            {
              type: "message",
              text: "Vous prenez le temps de discuter avec les habitants.",
            },
      ...
      actions: [
        {
          ...
          effects: [
            {
              type: "message",
              text: "Voici les dernières annonces du Royaume.",
            },
          ],
        },
      ],
  ...
  },
  {
    ...
    name: "Libre",
    description:
      "Commence avec une page blanche et ajoute uniquement ce dont tu as besoin.",
    example: "Pour un concept vraiment unique",
    payload: {
      building_kind: "custom",
      emoji: "✨",
      color: "64748b",
      description: "Un nouveau lieu du Royaume.",
      actions: [],
    },
  },
];

window.kingdomSlug = (value) =>
  String(value || "")
    .normalize("NFD")
    .replace(/[\u0300-\u036f]/g, "")
    .toLowerCase()
